---
title: "【蓝桥杯】进阶-状态压缩动态规划的典型题型深入分析"
pubDate: 2024-05-06
chapter: algorithms
tags: ["蓝桥杯", "动态规划"]
legacy: true
...
### 2. 1 [生命之树-真题](https://www.lanqiao.cn/problems/131/learning/)

![图片描述](/images/DSA-DynamicProgrammingType/uid1792586-20240418-1713417459185.png)
...
![图片描述](/images/DSA-DynamicProgrammingType/uid1792586-20240418-1713419773909.png)

绿色的代表我们选择的点集合。这些点是连通的，所以满足要求。

如果换成这个样子：

![图片描述](/images/DSA-DynamicProgrammingType/uid1792586-20240418-1713419870334.png)
...
### 3.1 [小明的背包6](https://www.lanqiao.cn/problems/131/learning/)

![图片描述](/images/DSA-DynamicProgrammingType/uid1792586-20240418-1713421022535.png)
...
![图片描述](/images/DSA-DynamicProgrammingType/uid1792586-20240418-1713421190949.png)
...
void dfs(int u) {
    for (int i = v[u]; i = v[u] + v[i]; --j) {
            for (int k = v[i]; k > n >> V;
    int s;
    for (int i = 1; i > v[i] >> w[i] >> s;
        G[s].push_back(i);
    }
    dfs(0);
    cout 
...
![图片描述](/images/DSA-DynamicProgrammingType/uid1792586-20240418-1713424406656.png)
...
![图片描述](/images/DSA-DynamicProgrammingType/uid1792586-20240418-1713424716921.png)
...
### 4.1 [卖树](https://www.lanqiao.cn/problems/3029/learning/)

![图片描述](/images/DSA-DynamicProgrammingType/uid1792586-20240418-1713424080194.png)
